...
public static  void  main(String[] args) { 
	  ...
	  driver.navigate().to("https://demoqa.com/webtables");
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div[2]/form/div[1]/div[2]/input")).sendKeys("");
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div[2]/form/div[5]/div[2]/input")).sendKeys("");
